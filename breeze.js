/**
 * BreezeCSS v2.2.3 — breeze.js
 * Autor: Pedro de Oliveira
 * Ponto de entrada público da biblioteca (módulos ES)
 *
 * Uso básico:
...
const BreezeCSS = {
     ...
     *
     * Lê directamente o <style> injectado no browser, garantindo que o output
     * reflecte o estado final da página. Seletores dinâmicos [data-breeze-id="bN"]
     * são convertidos para seletores de classe CSS portáveis.
     *
     * @param {object}  opcoes
     ...
     */
    exportar: (opcoes = {}) => Engine.exportar(opcoes),
...
// ─── Auto-init ──────────────────────────────────────────────────────────────
// Se a biblioteca for incluída via <script type="module">, inicializa
// automaticamente após o DOM estar carregado.
// Pode ser desactivado com data-no-auto-init na tag <script>.
